...
$condition = "status=1 AND FIND_IN_SET('History & Culture', tour_types)";
...
<meta name="description" content="Book 5-Star Niagara Falls History & Culture Tours incl. Hornblower Cruise, Skylon & Journey! 24 hr Cancellation Free. Fun Energetic Guides. Free Hotel Pick Up. Skip the Lines."/>
<meta name="keywords" content="History & Culture Tours"/>
<link rel="canonical" href="<?=SITEURL;?>/tour-type/history-culture" />
<title>Best Niagara Falls History & Culture Tours <?php echo date('Y'); ?> | <?php tour_count_all($conn, $condition, "$order"); ?> Affordable Tours Available | ToNiagara</title>
<?php include '../inner_header.php';?>
<!--banner-->
<div class="history-culture_banner_wra">
...
<div class="search_home_wra">
	<form action="<?=SITEURL;?>/tour-type/history-culture" method="get" id="search_form">
  <div class="ui-widget">
   ...
   <input type="hidden" name="tour_types" value="History & Culture" />
