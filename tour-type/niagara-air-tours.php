...
$condition = "status=1 AND FIND_IN_SET('Niagara Air Tours', tour_types)";
...
<meta name="description" content="Book 5-Star Niagara Falls Niagara Air Tours incl. Hornblower Cruise, Skylon & Journey! 24 hr Cancellation Free. Fun Energetic Guides. Free Hotel Pick Up. Skip the Lines."/>
<meta name="keywords" content="Niagara Air Tours"/>
<link rel="canonical" href="<?=SITEURL;?>/tour-type/niagara-air-tours" />
<title>Best Niagara Falls Niagara Air Tours <?php echo date('Y'); ?> | <?php tour_count_all($conn, $condition, "$order"); ?> Affordable Tours Available | ToNiagara</title>
<?php include '../inner_header.php';?>
<!--banner-->
<div class="niagara-air-tours_banner_wra">
...
<div class="search_home_wra">
	<form action="<?=SITEURL;?>/tour-type/niagara-air-tours" method="get" id="search_form">
  <div class="ui-widget">
   ...
   <input type="hidden" name="tour_types" value="Niagara Air Tours" />
