...
$condition = "status=1 AND FIND_IN_SET('Wine Tours', tour_types)";
...
<meta name="description" content="Book 5-Star Niagara Falls Winery & Brewery Tours incl. Hornblower Cruise, Skylon & Journey! 24 hr Cancellation Free. Fun Energetic Guides. Free Hotel Pick Up. Skip the Lines."/>
<meta name="keywords" content="Winery & Brewery Tours"/>
<link rel="canonical" href="<?=SITEURL;?>/tour-type/wine-tours" />
<title>Best Niagara Falls Wine Tours <?php echo date('Y'); ?> | <?php tour_count_all($conn, $condition, "$order"); ?> Affordable Tours Available | ToNiagara</title>
<?php include '../inner_header.php';?>
<!--banner-->
<div class="wine-tours_banner_wra">
<div class="detail_banner_shadow">
  <div class="container">
    <div class="row">
      <div class="col-lg-12">
        <div class="banner_txt_l">
        <h3>5 Hour Afternoon Winery Tour with Cheese Pairing and Chocolate Factory Visit</h3>
        <h2>Wine Tours</h2>
        </div>
      </div>  
    </div>
...
<div class="search_home_wra">
	<form action="<?=SITEURL;?>/tour-type/wine-tours" method="get" id="search_form">
  <div class="ui-widget">
   ...
   <input type="hidden" name="tour_types" value="Wine Tours" />
