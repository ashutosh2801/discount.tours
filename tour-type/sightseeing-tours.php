...
$condition = "status=1 AND FIND_IN_SET('Sightseeing tours', tour_types)";
...
<meta name="description" content="Book 5-Star Niagara Falls Sightseeing Tours incl. Hornblower Cruise, Skylon & Journey! 24 hr Cancellation Free. Fun Energetic Guides. Free Hotel Pick Up. Skip the Lines."/>
<meta name="keywords" content="Sightseeing Tours"/>
<link rel="canonical" href="<?=SITEURL;?>/tour-type/sightseeing-tours" />
<title>Best Niagara Falls Sightseeing Tours <?php echo date('Y'); ?> | <?php tour_count_all($conn, $condition, "$order"); ?> Affordable Tours Available | ToNiagara</title>
<?php include '../inner_header.php';?>
<!--banner-->
<div class="sightseeing-tours_banner_wra">
<div class="detail_banner_shadow">
  <div class="container">
    <div class="row">
      <div class="col-lg-12">
        <div class="banner_txt_l">
        <h3>Half Day Trip (4 Hours)</h3>
...
<div class="search_home_wra">
	<form action="<?=SITEURL;?>/tour-type/sightseeing-tours" method="get" id="search_form">
  <div class="ui-widget">
   ...
   <input type="hidden" name="tour_types" value="Sightseeing Tours" />
