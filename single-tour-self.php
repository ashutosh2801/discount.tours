    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="price2">
						<?php echo $tour->original_price ? '<span>CA$'.$tour->original_price.'</span>':''; ?>
...
<?php
$count=0; $num=1;
//if($tour->safe_private_tours) $count++;
//if($tour->free_cancellaton) $count++;
//if($tour->travelers_choice) $count++;
//if($tour->customer_rated) $count++;

//$col = 12/$count;
$class = "col-lg-3 col-md-3 col-sm-3 col-xs-3";
if( ($tour->safe_private_tours) || ($tour->free_cancellaton) || ($tour->travelers_choice) || ($tour->customer_rated) ) {
?>
<div class="icons_row2">
  <div class="container">
      
      <div class="row">
    <?php if($tour->safe_private_tours) { ?>
    <div class="<?php echo $class; ?>">
      <div class="icon_box">
        <img src="/images/safe.png" alt="safe.png" class="img-res">
        <h3><span class="safe">Safe</span> & Private Tours</h3>
        <div class="num">0<?php echo $num++; ?></div>
        <div class="clear"></div>
      </div>
    </div>
    <?php } if($tour->free_cancellaton) { ?>
    <div class="<?php echo $class; ?>">
      <div class="icon_box">
  ...
  <div class="container">
    <div class="row">
        <div class="col-lg-12">
          ...
          <?php /*?><div class="infant"><i class="fa fa-child"></i> Free for infants (0-3 years)</div><?php */?>
        </div>
     </div>
...
<div class="tab_matter_wra">
  <div class="container">
        ...
        <div class="row">
            <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12">
              ...
              <ul class="nav nav-tabs tab_my" role="tablist">
                ...
                <?php if($tour->is_tour_map) { ?><li role="presentation"><a href="#tour_map" aria-controls="tour_map" role="tab" data-toggle="tab"><i class="fa fa-map-o"></i> Tour Map</a></li><?php } ?>
              </ul>
    ...
    <input type="hidden" name="rating" id="rating" value="0" />                      
                    ...
                    <div class="heading5"><?php echo $no_reviews; ?> Reviews</div>
