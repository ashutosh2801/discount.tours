              ...
              <div class="w3l-table-info agile_info_shadow">
                ...
                <table id="table">
                  ...
                  <?php
									...
									$sql = "SELECT c.id, c.order_id , c.status, c.created_date, cd.* FROM `tour_customers` c, `tour_customer_detail` cd WHERE $condition ORDER BY cd.tour_date DESC";
                    ...
                    <tr>
                      ...
                      <td><?php echo $row->status==2?'<a class="badge badge-success">$ Paid</a>':'<a class="badge badge-warning">$ Balance</a>'; ?></td>
                      <td>
                        <?php /*?><a href="customers_unconfirm_view.php?id=<?php echo $row->id; ?>" class="badge badge-primary"><i class="fa fa-eye"></i> View</a><?php */?>
                        ...
                        <a href="decline.php?orderId=<?php echo $row->order_id; ?>" class="badge badge-danger" onClick="return confirm('Do you want to DECLINE payment?')"><i class="fa fa-close"></i> Declined</a>
												<?php /*?><a href="customers_unconfirm.php?id=<?php echo $row->id; ?>&act=remove" class="badge badge-danger" onClick="return confirm('Are you sure?')"><i class="fa fa-trash-o"></i> Delete</a><?php */?>
                      </td>
                    </tr>
                  <?php
                  		}
