              ...
              <div class="w3l-table-info agile_info_shadow">
                ...
                <table id="table"  class="table">
                  ...
                  <?php
                    ...
                    <thead>
                      <tr>
                      <th style="background:#c16a6a">Tour Date</th>
                      <th style="background:#c16a6a">Tour Title</th>
                      <th style="background:#c16a6a;">Pickup Location</th>
                      <th width="210" style="background:#c16a6a;text-align:right">Tour Detail</th>
                      <th width="210" style="background:#c16a6a;text-align:right">Tour Add Ons</th>
                      <th width="100" style="background:#c16a6a;text-align:right">Sub Total</th>
                      <th style="background:#c16a6a;text-align:right">Tax</th>
                      <th style="background:#c16a6a;text-align:right">Gratuity</th>
                      <th style="background:#c16a6a;text-align:right">Total</th>
                      </tr>
                    </thead>
                    <tbody>
                    <?php
