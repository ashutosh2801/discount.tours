...
function show_popup_crop(url, image_path, image_name) {
...
function crop_photo() {
	...
	var image_path_ = $('#image_path').val();
	var image_name_ = $('#image_name').val();
	var tour_id_ 		= $('#tour_id').val();
	...
	// display the loading texte
	$('#loading_progress').html('<img src="images/loader.gif"> Processing...');
	// crop photo with a php file using ajax call
	$.ajax({
		url: 'crop_photo.php',
		type: 'POST',
		data: {x:x_, y:y_, w:w_, h:h_, photo_url:photo_url_, image_path:image_path_, tour_id:tour_id_, image_name:image_name_, title:title_, targ_w:TARGET_W, targ_h:TARGET_H},
