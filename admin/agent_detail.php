...
<html lang="en">
<head>
<title>All Bookings THROUGH <?php echo $user->name; ?> Agent :: <?php echo SITENAME; ?></title>
        ...
        <!-- /inner_content_w3_agile_info-->
          ...
          <div class="w3l_agileits_breadcrumbs">
            <div class="w3l_agileits_breadcrumbs_inner">
              <ul>
                ...
                <li><a href="index.php">All Bookings THROUGH <u><?php echo $user->name; ?></u> Agent</a><span>«</span></li>
                <li>List</li>
              </ul>
            </div>
          </div>
          <!-- //breadcrumbs -->
					...
					<div class="inner_content_w3_agile_info two_in">
					  <h2 class="w3_inner_tittle">All Bookings THROUGH <u><?php echo $user->name; ?></u> Agent</h2>
            <!-- tables -->
            <?php 
            ...
            <div class="agile-tables">
              <div class="w3l-table-info agile_info_shadow">
                ...
                <table id="table"  class="table">
                  <thead>
                  	<tr>
                    	<th colspan="7" style="background:#fff" onClick="return confirm('Do you want to send to TRASH?')"><button type="submit" class="btn btn-danger" name="trash"><i class="fa fa-trash"></i> Trash All</button></th>
                    </tr>
                    <tr>
                  ...
                  <tbody>
                  <?php
									$condition = "c.id=cd.user_id AND c.agent_id=".$_GET['Id'];
									if(!empty($_GET['q'])) {
                    ...
                    <tbody>
                    <?php
                    $sql3 = "SELECT c.id, c.status, c.order_id, c.created_date, cd.*, t.ID, t.title, t.sub_title, t.slug, t.tour_thumb, t.price_type FROM `".PREFIX."customers` c, `".PREFIX."customer_detail` cd, ".PREFIX."tours t WHERE c.id=".$row->id." AND  c.id=cd.user_id AND cd.tour_id=t.ID AND c.agent_id=".$_GET['Id']." ORDER BY cd.tour_date DESC";
