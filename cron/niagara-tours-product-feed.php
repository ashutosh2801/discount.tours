...
{
	$delimiter = ",";
	$filename = "niagara-tours-product-feed.csv";
	
	$output = fopen("php://memory", "w");  
	$fields = array('id', 'title', 'description', 'link', 'image_link', 'additional_image_link', 'travel_type', 'category_name', 'price', 'location_name', 'city', 'province_state', 'country', 'phone_number', 'latitude', 'longitude', 'star_rating', 'region_name', 'proximity_city', 'proximity_airport', 'origin_name', 'origin_code', 'origin_city', 'origin_country', 'origin_latitude', 'origin_longitude', 'destination_name', 'destination_city', 'destination_country', 'destination_latitude', 'destination_longitude', 'free_cancellation', 'payment_options', 'tax_fees', 'availability_start', 'availability_end', 'included_guests_count', 'age_restrictions', 'included_activities', 'itinerary', 'duration', 'brand'); 
